...
def gen_proto():
    ...
    # print
    # print "*******************************************************"
    # print "*   Generating protocol buffer files for core...     *"
    # print "*******************************************************"
    # proto_files = work_dir(proto_core_dir)
    # java_out_path = proto_java_dir.format("core")
    # if os.path.exists(java_out_path + "/com"):
    #     rm_dir(java_out_path + "/com")
    # proto_files = remove_if_exist(proto_files, proto_mall_dir + os.path.sep + "grpc.proto")
    # protobuf_args = "-I=" + proto_dir + " " + "--java_out=" + java_out_path
    # command=protobuf_exe + " " + protobuf_args + " " + " ".join(proto_files)
    # print "Command: " + command
    # if not os.path.exists(java_out_path):
    #     os.makedirs(java_out_path)
    # exe_command(command)
    # # proto_files = remove_if_exist(proto_files, proto_mall_dir + os.path.sep + "connector.proto")
    # gen_interface("core", proto_files)

    # print
    # print "*******************************************************"
    # print "*   Generating protocol buffer files for mall...     *"
    # print "*******************************************************"
    # proto_files = work_dir(proto_mall_dir)
    # java_out_path = proto_java_dir.format("mall")
    # if os.path.exists(java_out_path + "/com"):
    #     rm_dir(java_out_path + "/com")
    # proto_files = remove_if_exist(proto_files, proto_mall_dir + os.path.sep + "grpc.proto")
    # protobuf_args = "-I=" + proto_dir + " " + "--java_out=" + java_out_path
    ...
    # exe_command(command)
    # # proto_files = remove_if_exist(proto_files, proto_mall_dir + os.path.sep + "connector.proto")
    # gen_interface("mall", proto_files)

    # print
    # print "*******************************************************"
    # print "*   Generating protocol buffer files for boss...     *"
    # print "*******************************************************"
    # proto_files = work_dir(proto_boss_dir)
    # java_out_path = proto_java_dir.format("boss")
    # if os.path.exists(java_out_path + "/com"):
    #     rm_dir(java_out_path + "/com")
    # proto_files = remove_if_exist(proto_files, proto_boss_dir + os.path.sep + "grpc.proto")
    # protobuf_args = "-I=" + proto_dir + " " + "--java_out=" + java_out_path
    # command=protobuf_exe + " " + protobuf_args + " " + " ".join(proto_files)
    # print "Command: " + command
    # if not os.path.exists(java_out_path):
    #     os.makedirs(java_out_path)
    # exe_command(command)
    # # proto_files = remove_if_exist(proto_files, proto_boss_dir + os.path.sep + "connector.proto")
    # gen_interface("boss", proto_files)

    # print
    # print "*******************************************************"
    # print "*   Generating protocol buffer files for open...     *"
    # print "*******************************************************"
    # proto_files = work_dir(proto_open_dir)
    # java_out_path = proto_java_dir.format("open")
    # proto_files = remove_if_exist(proto_files, proto_open_dir + os.path.sep + "grpc.proto")
    # protobuf_args = "-I=" + proto_dir + " " + "--java_out=" + java_out_path
    # command=protobuf_exe + " " + protobuf_args + " " + " ".join(proto_files)
    # print "Command: " + command
    # if not os.path.exists(java_out_path):
    #     os.makedirs(java_out_path)
    # exe_command(command)
    # # proto_files = remove_if_exist(proto_files, proto_open_dir + os.path.sep + "connector.proto")
    # gen_interface("open", proto_files)

    # print
    # print "*******************************************************"
    # print "*   Generating protocol buffer files for erp...     *"
    # print "*******************************************************"
    # proto_files = work_dir(proto_erp_dir)
    # java_out_path = proto_java_dir.format("erp")
    # proto_files = remove_if_exist(proto_files, proto_erp_dir + os.path.sep + "grpc.proto")
    # protobuf_args = "-I=" + proto_dir + " " + "--java_out=" + java_out_path
    # command=protobuf_exe + " " + protobuf_args + " " + " ".join(proto_files)
    # print "Command: " + command
    # if not os.path.exists(java_out_path):
    #     os.makedirs(java_out_path)
    # exe_command(command)
    # # proto_files = remove_if_exist(proto_files, proto_erp_dir + os.path.sep + "connector.proto")
    # gen_interface("erp", proto_files)

    # print
    # print "*******************************************************"
    # print "*   Generating protocol buffer files for css...     *"
    # print "*******************************************************"
    # proto_files = work_dir(proto_css_dir)
    # java_out_path = proto_java_dir.format("css")
    # proto_files = remove_if_exist(proto_files, proto_css_dir + os.path.sep + "grpc.proto")
    # protobuf_args = "-I=" + proto_dir + " " + "--java_out=" + java_out_path
    # command=protobuf_exe + " " + protobuf_args + " " + " ".join(proto_files)
    # print "Command: " + command
    # if not os.path.exists(java_out_path):
    #     os.makedirs(java_out_path)
    # exe_command(command)
    # proto_files = remove_if_exist(proto_files, proto_css_dir + os.path.sep + "connector.proto")
    # proto_files = remove_if_exist(proto_files, proto_css_dir + os.path.sep + "websocket.proto")
    # gen_interface("css", proto_files)
