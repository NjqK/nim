...
public class MsgReadExample {
     ...
     * @mbg.generated
     */
    public MsgReadExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public MsgReadExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public MsgReadExample page(Integer page, Integer pageSize) {
